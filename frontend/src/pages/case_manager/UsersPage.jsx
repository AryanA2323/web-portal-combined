...
const ADMIN_PAGES = [
  ...
  { path: '/case_manager/users', label: 'Users' },
  { path: '/case_manager/clients', label: 'Clients' },
...
const UsersPage = () => {
  ...
  const filteredUsers = users.filter(user => {
    ...
    // For CASE_MANAGER filter, check role is CASE_MANAGER and sub_role is not SUPER_ADMIN
    if (roleFilter === 'CASE_MANAGER') {
      return user.role?.toUpperCase() === 'CASE_MANAGER' &&
        user.sub_role?.toUpperCase() !== 'SUPER_ADMIN' &&
        ...
        <Box sx={{ mb: 3 }}>
          <FormControl sx={{ minWidth: 250 }}>
            ...
            >
              ...
              <MenuItem value="CASE_MANAGER">Case Managers</MenuItem>
                  ...
                  <>
                    <Grid item xs={12}>
                      ...
                      <Typography variant="body2" color="text.secondary" gutterBottom>
                        Toggle individual pages for this case manager user. Select the pages they can access.
                      </Typography>
                    </Grid>
                    <Grid item xs={12}>
