...
CORS_ALLOWED_ORIGINS = os.environ.get(
    ...
    'http://localhost:3000,http://127.0.0.1:3000,http://192.168.31.164:8081,http://192.168.31.164:8000'
).split(',')
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@incidentmanagement.com')
...
SPEECH_MAX_DURATION_SECONDS = int(os.environ.get('SPEECH_MAX_DURATION_SECONDS', '300'))
