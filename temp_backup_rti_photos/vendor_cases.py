...
_CHECK_DETAIL_COLUMNS = {
    'claimant_checks': {
        'select': '''cc.id, cc.case_id, cc.check_status,
                     ...
                     cc.questionnaire, cc.vendor_feedback''',
        'alias': 'cc',
    ...
    'insured_checks': {
        'select': '''ic.id, ic.case_id, ic.check_status,
                     ...
                     ic.questionnaire, ic.vendor_feedback''',
        'alias': 'ic',
    ...
    'driver_checks': {
        'select': '''dc.id, dc.case_id, dc.check_status,
                     ...
                     dc.questionnaire, dc.vendor_feedback''',
        'alias': 'dc',
    ...
    'spot_checks': {
        'select': '''sc.id, sc.case_id, sc.check_status,
                     ...
                     sc.questionnaire, sc.vendor_feedback''',
        'alias': 'sc',
    ...
    'chargesheets': {
        'select': '''cs.id, cs.case_id, cs.check_status, cs.advocate_status,
                     ...
                     cs.questionnaire, cs.vendor_feedback,
    ...
    try:
        with connections['default'].cursor() as cursor:
            ...
            case_info = {
                ...
                "scope_of_work": (case_row[10] if case_row else "") or "",
