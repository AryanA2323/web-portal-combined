            ...
            with connections["default"].cursor() as cursor:
                cursor.execute(
                    ...
                    SELECT case_number, claim_number, client_name, category,
                           case_receive_date, receive_month, closure_date,
                           closure_month, case_due_date, tat_days, sla,
